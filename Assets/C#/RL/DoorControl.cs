...
public class DoorControl : MonoBehaviour
{
    ...
    public void AddNavMeshLink()
    {
        ...
        {
            Link.startPoint = new Vector3(0, -1.5f, 0.6f);
            Link.endPoint = new Vector3(0, -1.5f, -0.6f);
        }
        else if (doorDirection == "Horizontal")
        {
            Link.startPoint = new Vector3(0.6f, -1.5f, 0);
            Link.endPoint = new Vector3(-0.6f, -1.5f, 0);
        }
